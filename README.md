...
igualmente de la varianza hay dos maneras de calcular. La primera es la varianza muestral:
S2=∑i=ni=1(xi−x¯)2n−1,
que x¯ quiere decir el promedio muestral.

La varianza poblacional (σ2) se define así:

σ2=∑i=ni=1(xi−μ)2n,

donde μ representa el promedio poblacional.
...
S=∑i=ni=1(xi−x¯)2n−1−−−−−−−−−−−−√,
donde x¯ representa el promedio muestral.

La desviación estándar poblacional (σ) para n

observaciones se define así:

σ=∑i=ni=1(xi−μ)2n−−−−−−−−−−−−√,
donde μ representa el promedio de la población.
...
¿A qué se refiere el coeficiente de variación en un conjunto de datos? y ¿cómo se determina en R? es la relacion de el tamaño de la muestra y la media. el coeficiente de variación se define como CV=s/x¯ y con la función coef_var
...
Esto es lo que me dejo el caso
